              ...
              >
                <div class="px-4 flex-none">
                  <div class="" style="width: 90px; height: 90px">
                    <img
                      src="{{ $item->products->galleries()->exists() 
                        ? Storage::url($item->products->galleries->first()->url) 
                ...
                <div class="px-4 w-auto flex-1 md:w-5/12">
                  <div class="">
                    ...
                    >
                      IDR {{ number_format($item->products->price) }}
                    </h6>
                  </div>
                </div>
                <div
                ...
                >
                  <div class="">
                    <h6 class="font-semibold text-lg">IDR {{ number_format($item->products->price) }}</h6>
                  </div>
                </div>
                <div class="px-4 w-2/12">
                  <div class="text-center">
                ...
                <div class="flex flex-col mb-4">
                  ...
                  <div class="flex -mx-2 flex-wrap">
                    ...
                    <div class="px-2 w-6/12 h-24 mb-4">
                      ...
                      >
                        <img
                          src="{{ url('/frontend/images/content/logo-mastercard.svg') }}"
                          alt="Logo mastercard"
                        />
                      </button>
                    </div>
                    <div class="px-2 w-6/12 h-24 mb-4">
                      ...
                      >
                        <img
                          src="{{ url('/frontend/images/content/logo-bitcoin.svg') }}"
                          alt="Logo bitcoin"
                          class="object-contain max-h-full"
                        />
                      </button>
                    ...
                    <div class="px-2 w-6/12 h-24 mb-4">
                      ...
                      >
                        <img
                          src="{{ url('/frontend/images/content/logo-american-express.svg') }}"
