                ...
                <div class="flex flex-col mb-4">
                  ...
                  <div class="flex -mx-2 flex-wrap">
                    <div class="px-2 w-6/12 h-24 mb-4">
                      ...
                      >
                        <img
                          src="{{ url('/images/content/logo-fedex.svg') }}"
                          alt="Logo Fedex"
                    ...
                    <div class="px-2 w-6/12 h-24 mb-4">
                      ...
                      >
                        <img
                          src="{{ url('/images/content/logo-dhl.svg') }}"
                          alt="Logo dhl"
                          class="object-contain max-h-full"
                        />
                      </button>
                ...
                <div class="flex flex-col mb-4">
                  ...
                  <div class="flex -mx-2 flex-wrap">
                    <div class="px-2 w-6/12 h-24 mb-4">
                      ...
                      >
                        <img
                          src="{{ url('/images/content/logo-midtrans.png') }}"
                          alt="Logo midtrans"
                          class="object-contain max-h-full"
                        />
                      </button>
                    ...
                    <div class="px-2 w-6/12 h-24 mb-4">
                      ...
                      >
                        <img
                          src="{{ url('/images/content/logo-mastercard.svg') }}"
                          alt="Logo mastercard"
                        />
                      </button>
                    </div>
                    <div class="px-2 w-6/12 h-24 mb-4">
                      ...
                      >
                        <img
                          src="{{ url('/images/content/logo-bitcoin.svg') }}"
                          alt="Logo bitcoin"
                          class="object-contain max-h-full"
                        />
                      </button>
                    ...
                    <div class="px-2 w-6/12 h-24 mb-4">
                      ...
                      >
                        <img
                          src="{{ url('/images/content/logo-american-express.svg') }}"
